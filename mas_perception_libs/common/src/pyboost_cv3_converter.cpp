...
public:
    ...
    UMatData* allocate(PyObject* o, int dims, const int* sizes, int type, size_t* step) const
    {
        ...
        u->data = u->origdata = reinterpret_cast<uchar*>(PyArray_DATA(reinterpret_cast<PyArrayObject*>(o)));
...
void* matFromNDArrayBoostConverter::convertible(PyObject* object)
{
    ...
    const int CV_MAX_DIM = 32;
#endif
    PyArrayObject* oarr = reinterpret_cast<PyArrayObject*>(object);
        ...
        PyObject* object, boost::python::converter::rvalue_from_python_stage1_data* data)
{
    ...
    if (needcopy)
    {
        if (needcast)
        {
            ...
            oarr = reinterpret_cast<PyArrayObject*>(object);
        }
        else
        {
            oarr = PyArray_GETCONTIGUOUS(oarr);
            object = reinterpret_cast<PyObject*>(oarr);
        }
